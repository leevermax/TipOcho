...
<head>
    ...
    <!-- CATEGORY CSS -->
    <link rel="stylesheet" href="assets/css/categorys-style.css">
                ...
                <div class="row bodyHomeContentCol">
                    <div class="row contentCatePage1">
                        <div class="crTitlePage">
                            <h2>MMO - Kiếm Tiền Online</h2>
                        </div>
                        <div class="crDecreptionContentCategory">
                    ...
                    <div class="row contentCatePage1">
                        <div class="titleSildeRight titleNewPost" align="center">
                            <h6><i class="fas fa-hand-point-right"></i> Bài Viết Mới Trong MMO  - Kiếm Tiền Online</h6>
                        </div>
                        <div class="wrapPostOfCategory">
                            <div class="imgPostOfCategory">
                                <img src="https://ichef.bbci.co.uk/news/660/cpsprodpb/23ED/production/_104679190_0c02a63e-d285-4642-90da-5ddaeb915b10.jpg" class="rounded imgPostCat">
                            </div>
                            <div class="contentTextPostCategory">
                                ...
                                <div class="desrectionPostCat">
                                    ãdscassssdvd
                                </div>
                                <div class="row datePostAndViewa">
                        ...
                        <div class="row sPlitPage">
                            <ul class="pagination pTr-modal-3">
